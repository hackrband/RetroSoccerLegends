...
win.title('Retro Soccer Legends')
win.tracer(0)
w, h = win.window_width(),win.window_height()
...
# player movement functions with increased speed
def up():
    if started:
        player.seth(90)
        player.fd(10)  # Increase movement distance
